...
# Data loading params
tf.flags.DEFINE_float("test_size", .2, "Percentage of the training data to use for validation")
...
def preprocess():
    ...
    print('{} samples into x_txt'.format(sample_num))
    ...
    x_train, x_dev, y_train, y_dev = train_test_split(x_shuffled, y_shuffled, FLAGS.test_size, random_state=0)
    ...
    return x_train, x_dev, vocab_processor, y_train, y_dev, embedding
